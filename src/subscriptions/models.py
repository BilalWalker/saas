...
class Subscription(models.Model):
    ...
    features = models.TextField(help_text="Festures for pricing, seperated by new line", blank=True, null=True)
...
def user_sub_post_save(sender, instance, *args, **kwargs):
    ...
    if not ALLOW_CUSTOM_GROUPS:
        ...
        subs_groups_set = set(subs_groups) # all of subscription group id set except for current one
        # groups_ids = groups.values_list('id', flat=True) # flat=True will give us all ids as list
