...
def get_checkout_customer_plan(session_id):
    ...
    current_period_end = date_utils.timestamp_as_datetime(sub_r.get('items').get('data')[0].get('current_period_end'))
    current_period_start = date_utils.timestamp_as_datetime(sub_r.get('items').get('data')[0].get('current_period_start'))
    data = {
